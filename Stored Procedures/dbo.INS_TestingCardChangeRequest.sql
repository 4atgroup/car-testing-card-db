...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE dbo.INS_TestingCardChangeRequest(
@TestingCardID int,
...
@AdministratorPersonID int=NULL)as BEGIN  BEGIN TRY 
 INSERT INTO dbo.TestingCardChangeRequest([TestingCardID],
[Number],
[TestingCardChangeRequestNumber],
[VIN],
[CarModel],
[CarNumber],
[CarSerialNo],
...
[AdministratorPersonID]) values (@TestingCardID,
@Number,
@TestingCardChangeRequestNumber,
@VIN,
@CarModel,
